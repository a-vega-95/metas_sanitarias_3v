...
def calcular_meta_4(agno=None, max_mes=None):
    ...
    if DATA_DIR is None:
        print(f"[Meta 4] Sin corte Serie P disponible para m_limit={m_limit}. Omitiendo.")
        return
    ...
    for c in all_centers:
        ...
        reporte.append({
            ...
            'Meta_Fijada': META_FIJADA_4A, 'Meta_Nacional': META_NACIONAL_4A
        })
        ...
        params_4b = config.get_meta_params('Meta_4B', agno_eval)
        reporte.append({
