...
def calcular_meta_3(agno=None, max_mes=None):
    ...
    DATA_DIR_A = os.path.join(ENTRADA_DIR, str(agno_eval), "SERIE_A")
    ...
    for c in all_centers:
        ...
        params_3a = config.get_meta_params('Meta_3A', agno_eval)
        ...
        params_3b = config.get_meta_params('Meta_3B', agno_eval)
