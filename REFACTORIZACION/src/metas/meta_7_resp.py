...
def calcular_meta_7(agno=None, max_mes=None):
    ...
    if dir_p is None:
        print(f"[Meta 7] Sin corte Serie P disponible para m_limit={m_limit}. Omitiendo.")
        return
    mapping = scan_rem_files(dir_p)
    ...
    for c in all_centers:
        ...
        reporte.append({
            ...
            'Meta_Fijada': META_FIJADA_7, 'Meta_Nacional': META_NACIONAL_7
        })
